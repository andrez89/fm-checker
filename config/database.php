    ...
    */
    ...
    'connections' => [
        ...
        'fms' => [
            ...
            'cache_session_token' => env('DB_CACHE_SESSION_TOKEN', false), // set to false to log out after each reqeust. This can be slower than re-using a session token, but allows for globals to be set for individual user values.
